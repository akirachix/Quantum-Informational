const Defination = () => {
  return (
    <div>
      <div className="h-24 md:w-full lg:h-32 md:text-md bg-yellow-200">
        <h1
          className="text-3xl font-bold text-center pt-8 sm:text-3xl xl:text-5xl md:text-6xl lg:text-5xl lg:pt-12"
